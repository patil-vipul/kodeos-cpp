...
void KeyboardEventHandler::OnModKeyDown(uint8_t){
...
uint32_t KeyboardDriver::HandleInterrupt(uint32_t esp)
{
    ...
    if(key < 0x80)
    {
        switch(key)
        {
            case 0x01: handler->OnModKeyDown(key); break;
            ...
            case 0x1C:
            handler->OnModKeyDown(key);
            handler->OnKeyDown('\n'); 
            break;
            case 0x39: handler->OnKeyDown(' '); break;

            case 0x4D: handler->OnModKeyDown(key); break;
            case 0x50: handler->OnModKeyDown(key); break;
            case 0x4B: handler->OnModKeyDown(key); break;
            case 0x48: handler->OnModKeyDown(key); break;
